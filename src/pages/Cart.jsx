...
const Cart = () => {
  ...
  const [address, setAddress] = useState("main street 2032");
        ...
        <div>
          ...
          <div className="flex flex-col md:flex-row justify-between space-x-10 mt-8">
            <div className="md:w-2/3">
              ...
              <div>
                {cart.products.map((product) => (
                  ...
                  >
                    <div className="flex flex-col justify-start md:flex items-center ">
                      <img
                        src={product.image}
                        // alt={product.name}
                        className="w-16 h-16 object-contain rounded"
                      />
                      <div className="flex-1 ml-4 space-r-4">
            ...
            <div className="md:w-1/3 bg-white p-6 rounded-lg shadow-md border border-gray-300">
              ...
              <button className="w-full bg-red-600 text-white py-2 hover:bg-red-800 cursor-pointer" onClick={()=>navigate('/checkout')}>
